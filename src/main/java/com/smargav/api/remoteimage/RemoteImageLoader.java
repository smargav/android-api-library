...
public class RemoteImageLoader {
    ...
    public static final int DEFAULT_TTL_MINUTES = 24 * 60;
    public static final int DEFAULT_NUM_RETRIES = 1;
    // seems more like the size we're using!
    public static final int DEFAULT_BUFFER_SIZE = 200000;
     ...
     * @param createCache whether to create a default {@link ImageCache} used for caching
     */
     ...
     *
     * @param defaultBufferSize how big the buffer should be into which the image file is read. This should be big
     ...
     *
     * @param imageUrl                          the URL of the image to download
     * @param textView                          the TextView which should be updated with the new compound drawable
     * @param dummyDrawable                     the Drawable to be shown while the image is being downloaded.
     * @param compoundDrawablesEnabledPositions the positions where compound drawables should be shown (left, top, right, bottom).
     ...
     * @param imageUrl  the URL of the image to download
     * @param imageView the ImageView which should be updated with the new image
     * @param handler   the handler that will process the bitmap after completion
    ...
    /**
     * @param imageUrl      the URL of the image to download
     * @param view          the View which should be updated with the new image
     * @param dummyDrawable the Drawable to be shown while the image is being downloaded.
     * @param handler       the handler that will process the bitmap after completion
    ...
    public void loadImage(Drawable dummyDrawable, RemoteImageLoaderHandler handler) {
        ...
        RemoteImageLoaderHandler.RemoteImageLoaderViewAdapter remoteImageLoaderViewAdapter = imageLoaderHandler
