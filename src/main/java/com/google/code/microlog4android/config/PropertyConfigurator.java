...
public class PropertyConfigurator {
    private static final String TAG = "SGV.PropertyConfig";
     ...
     */
    public static final String ROOT_LOGGER_KEY = "sgv.rootLogger";

    /**
     * The key for setting the logger.
     */
    public static final String LOGGER_PREFIX_KEY = "sgv.logger";

    /**
     * The key for setting the formatter.
     */
    public static final String FORMATTER_PREFIX_KEY = "sgv.formatter";

    /**
     * The key for setting the pattern.
     */
    public static final String PATTERN_LAYOUT_PREFIX_KEY = "sgv.formatter.PatternFormatter.pattern";


    /**
     * The key for setting the appender.
     */
    public static final String APPENDER_PREFIX_KEY = "sgv.appender";

    /**
     * The key for setting the file name for FileAppender.
     */
    public static final String FILE_APPENDER_FILE_NAME_KEY = "sgv.appender.FileAppender.File";

    /**
     * The key for setting the append.
     */
    public static final String FILE_APPENDER_APPEND_KEY = "sgv.appender.FileAppender.Append";


    /**
     * The key for setting the level.
     */
    public static final String LOG_LEVEL_PREFIX_KEY = "sgv.level";

    /**
     * The key for setting the logging tag.
     */
    public static final String TAG_PREFIX_KEY = "sgv.tag";

    public static final String[] APPENDER_ALIASES = {"LogCatAppender", "FileAppender"};

    public static final String[] APPENDER_CLASS_NAMES = {"com.google.code.com.microlog4android.appender.LogCatAppender",
            "com.google.code.com.microlog4android.appender.FileAppender"};

    public static final String[] FORMATTER_ALIASES = {"SimpleFormatter", "PatternFormatter"};

    public static final String[] FORMATTER_CLASS_NAMES = {"com.google.code.com.microlog4android.format.SimpleFormatter",
            "com.google.code.com.microlog4android.format.PatternFormatter"};
     ...
     *
     * @param context the {@link Context} to get the configurator for.
